...
$create_tb = "CREATE TABLE users (user_id int(6), first_name varchar(15), last_name varchar(15), user varchar(15), password varchar(32), avatar varchar(70), login_attempts int(6), PRIMARY KEY (user_id));";
...
$insert = "INSERT INTO users VALUES
	('1','admin','admin','admin',MD5('password'),'{$baseUrl}admin.jpg', '0'),
	('2','Gordon','Brown','gordonb',MD5('abc123'),'{$baseUrl}gordonb.jpg', '0'),
	('3','Hack','Me','1337',MD5('charley'),'{$baseUrl}1337.jpg', '0'),
	('4','Pablo','Picasso','pablo',MD5('letmein'),'{$baseUrl}pablo.jpg', '0'),
	('5','Bob','Smith','smithy',MD5('password'),'{$baseUrl}smithy.jpg', '0');";
